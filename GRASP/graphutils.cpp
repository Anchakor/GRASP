...
RDFNodeEditDialog::RDFNodeEditDialog(librdf_node **result, librdf_node *node, Graph *graph, bool urionly, QWidget *parent, Qt::WindowFlags f) : QDialog(parent, f), graph_(graph), result_(result)
{
    ui.setupUi(this);
